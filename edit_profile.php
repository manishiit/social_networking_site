		...
		<form action="" method="post" enctype="multipart/form-data">
			<table class="table table-bordered table-hover"> 
				...
				<tr>
					...
					<td>
						<input class="form-control" type="text" name="u_name" required value="<?php echo $user_email; ?>">
					</td>
				</tr>
				<tr>
					...
					<td>
						<select class="form-control" name="u_country">
							...
							<option>UAE</option> <option>UK</option>
							<option>India</option>
...
<?php
	if(isset($POST['update'])){
		...
		$u_name = htmlentities($_POST['u_name']); $describe_user= htmlentities ($_POST['describe_user']);
		$Relationship_status = htmlentities($_POST['Realtionship']); 
		...
		if($run){
			...
			echo"<script>window.open('edit_profile.php?u_id$user_id','self')</script>";
		}
	}
?>
